                                                    ...
                                                    <table style="background-color: #ffffff;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-m-txt-l es-p20t es-p15b es-p30r es-p30l" bgcolor="#ffffff" align="left">
                                                                <p>It happens. To keep your account active, just sign in and update your payment information. Press the button below to get started.<br></p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                            ...
                                            <tr>
                                                <td class="esd-container-frame" width="540" valign="top" align="center">
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        <tbody>
                                                        <tr>
                                                            <td class="esd-block-button es-p40t es-p40b es-p10r es-p10l" align="center"><span class="es-button-border" style="background: #ec6d64 none repeat scroll 0% 0%; border-color: #ec6d64;"><a href="https://viewstripo.email/" class="es-button" target="_blank" style="border-width: 15px 25px; background: #ec6d64 none repeat scroll 0% 0%; border-color: #ec6d64;">Update Payment Info</a></span></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table style="border-radius: 4px; border-collapse: separate; background-color: #111111;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#111111">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-m-txt-l es-p35t es-p30r es-p30l" bgcolor="#111111" align="left">
                                                                <h2 style="color: #ffffff;">Want to save money?<br></h2>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text es-p20t es-p30r es-p30l es-m-txt-l" align="left">
                                                                <p>By switching to annual billing, you'll&nbsp;<span style="color:#FFFFFF;">save 30%</span>&nbsp;on your account. We like to think of it as a just reward for our loyal friends.<br></p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text es-p20t es-p40b es-p30r es-p30l" align="left"><a target="_blank" href="https://viewstripo.email">Learn more about annual accounts</a></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="esd-container-frame" width="600" valign="top" align="center">
                                                    <table style="border-radius: 4px; border-collapse: separate;" width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p30b es-p30r es-p30l" align="center"><a target="_blank" href="https://viewstripo.email">We’re here, ready to talk</a></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
