                ...
                <div class="col-lg-6">
                    <div class="details_image">
                        ...
                        <div class="details_image_thumbnails d-flex flex-row align-items-start justify-content-between">
                            ...
                            <div class="details_image_thumbnail" data-image="images/details_2.jpg"><img src="{{asset("images/details_1.jpg")}}" alt=""></div>
                            <div class="details_image_thumbnail" data-image="images/details_3.jpg"><img src="{{asset("images/details_1.jpg")}}" alt=""></div>
                            <div class="details_image_thumbnail" data-image="images/details_4.jpg"><img src="{{asset("images/details_1.jpg")}}" alt=""></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="details_content">
                        ...
                        <div class="product_quantity_container">
                            ...
                            <div class="button cart_button"><a href="{{url("shopping/{$product->id}")}}">Add to cart</a></div>
                        </div>
